...
<head>
    ...
    <link href="../dist/css/tabler.css?1760059269" rel="stylesheet" />
    <link href="../preview/css/demo.css?1760059269" rel="stylesheet" />
    <style>
        @import url("https://rsms.me/inter/inter.css");
    </style>
</head>
<body>
    <script src="../dist/js/tabler-theme.min.js?1760059269"></script>
    <div class="page">
            ...
            <div class="container-xl">
                ...
                <div class="navbar-nav flex-row order-md-last">
                    <div class="nav-item d-none d-md-flex me-3">
                        <div class="btn-list">
                            <a href="https://github.com/tabler/tabler" class="btn btn-5" target="_blank" rel="noreferrer">Source code</a>
                        </div>
                    </div>
            ...
            <div class="page-header d-print-none" aria-label="Page header">
                <div class="container-xl">
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            <h2 class="page-title">Danh sách Liên Hệ</h2>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><button class="table-sort" data-sort="sort-name">Người gửi</button></th>
                                            <th><button class="table-sort" data-sort="sort-email">Email</button></th>
                                            <th><button class="table-sort" data-sort="sort-phone">SĐT</button></th>
                                            <th><button class="table-sort" data-sort="sort-message">Nội dung</button></th>
                                            <th><button class="table-sort" data-sort="sort-status">Trạng thái</button></th>
                                            <th><button class="table-sort" data-sort="sort-date">Ngày gửi</button></th>
                                            <th>Hành động</th>
                                        </tr>
                                    </thead>
                                    <tbody class="table-tbody">
                                        ...
                                        <tr>
                                            <td class="sort-id"><?php echo $contact['id']; ?></td>
                                            <td class="sort-name"><?php echo htmlspecialchars($contact['name']); ?></td>
                                            <td class="sort-email"><?php echo htmlspecialchars($contact['email']); ?></td>
                                            <td class="sort-phone"><?php echo htmlspecialchars($contact['phone']); ?></td>
                                            <td class="sort-message"><?php echo htmlspecialchars(substr($contact['message'], 0, 50)) . (strlen($contact['message']) > 50 ? '...' : ''); ?></td>
                                            <td class="sort-status">
                                                <span class="badge badge-outline text-<?php echo $contact['status'] == 'unread' ? 'danger' : ($contact['status'] == 'read' ? 'warning' : 'success'); ?>">
                                                    <?php echo $contact['status'] == 'unread' ? 'Unread' : ($contact['status'] == 'read' ? 'Read' : 'Replied'); ?>
                                                </span>
                                            </td>
                                            <td class="sort-date" data-date="<?php echo strtotime($contact['created_at']); ?>"><?php echo date('d/m/Y H:i', strtotime($contact['created_at'])); ?></td>
                                            <td>
                                                <form method="post" style="display: inline;">
                                                    ...
                                                    <?php endif; ?>
                                                    <button type="submit" name="delete" class="btn btn-sm btn-outline-danger" onclick="return confirm('Bạn có chắc là muốn xóa phản hồi này?')">Xóa</button>
                                                </form>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
    ...
    <script src="../dist/libs/list.js/dist/list.min.js?1760059269"></script>
    <script>
