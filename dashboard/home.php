                        ...
                        <div class="nav-item">
                            ...
                            <a href="?theme=light" class="nav-link px-0 hide-theme-light" title="Enable light mode" data-bs-toggle="tooltip" data-bs-placement="bottom">
                                ...
                                <svg
                                    ...
                                    class="icon icon-1"
                                >
                                    <path d="M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" />
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="./admin-product/index-manage.php"> Product Management  </a>
                                            <a class="dropdown-item" href="./admin-product/index-orders.php"> Orders </a>
                                            <a class="dropdown-item" href="./admin-product/index-cart.php"> Cart </a>
                                            <a class="dropdown-item" href="./admin-product/index-product.php"> Add New Product </a>
                                        </div>
                                    </li>
                                    <!-- vung thay doi /001 -->
